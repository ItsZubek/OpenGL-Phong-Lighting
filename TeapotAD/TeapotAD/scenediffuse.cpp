...
void SceneDiffuse::setLightParams(QuatCamera camera)
{
	...
	prog.setUniform("La", 0.3f, 0.3f, 0.3f); //ambient
	prog.setUniform("Ls", 0.3f, 0.3f, 0.3f); //specular
...
void SceneDiffuse::render(QuatCamera camera)
{
	...
	prog.setUniform("Ka", 0.51f, 1.0f, 0.49f); //ambient
	prog.setUniform("Ks", 0.1f, 0.1f, 0.1f); //specular
	...
	//Now set up the teapot 
	 ...
	 prog.setUniform("Ka", 0.46f, 0.29f, 0.0f); //ambient
	 prog.setUniform("Ks", 0.29f, 0.29f, 0.29f); //specular
